...
Page({
  ...
  loadAll() {
    ...
    wx.cloud.callFunction({ name: 'waypointFunctions', data: { action: 'getMyWaypoints' } })
      .then(({ result }) => {
      ...
      catList.sort((a, b) => { if (a.name === '其他') return 1; if (b.name === '其他') return -1; return 0; });
      ...
      this.setData({
        allWaypoints: all, waypoints: filtered,
